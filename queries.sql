...
ALTER TABLE tasks ADD COLUMN profile_id INT REFERENCES profiles(id) ON DELETE SET NULL;
ALTER TABLE lists ADD COLUMN profile_id INT REFERENCES profiles(id) ON DELETE SET NULL;